...
dependencies {
    ...
    implementation("org.springframework.modulith:spring-modulith-starter-core:1.2.13")
    ...
    testImplementation("org.springframework.modulith:spring-modulith-starter-test:1.2.13")

    testImplementation("com.tngtech.archunit:archunit-junit5:1.5.0")
    testImplementation("org.springframework.modulith:spring-modulith-docs:1.2.13")
