...
public class FlywayConfig {
    ...
    public void migrate() {
        ...
        modules.put("m1party", new ModuleInfo("classpath:db/migration/m1party", new String[] {"party"}, "party"));

        modules.put(
                "m1security",
                new ModuleInfo("classpath:db/migration/m1security", new String[] {"security"}, "security"));

        modules.put(
                "m2catalogue",
                new ModuleInfo("classpath:db/migration/m2catalogue", new String[] {"catalogue"}, "catalogue"));

        modules.put(
                "m3pricing", new ModuleInfo("classpath:db/migration/m3pricing", new String[] {"pricing"}, "pricing"));

        modules.put(
                "m4trading", new ModuleInfo("classpath:db/migration/m4trading", new String[] {"trading"}, "trading"));

        modules.put(
                "m5inventory",
                new ModuleInfo("classpath:db/migration/m5inventory", new String[] {"inventory"}, "inventory"));

        modules.put("m6pos", new ModuleInfo("classpath:db/migration/m6pos", new String[] {"pos"}, "pos"));

        modules.put(
                "m7customers",
                new ModuleInfo("classpath:db/migration/m7customers", new String[] {"customers"}, "customers"));

        modules.put(
                "m8reporting",
                new ModuleInfo("classpath:db/migration/m8reporting", new String[] {"reporting"}, "reporting"));
