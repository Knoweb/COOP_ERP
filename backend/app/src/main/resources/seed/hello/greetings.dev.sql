-- Development seed for the hello module (17A section 10: "the hello module's sample rows").
...
INSERT INTO hello.greeting (id, owner_entity_id, text_en, text_si, text_ta, status)
VALUES
    ...
    ('0190f000-0000-7000-8000-0000000a0003',
     '0190f000-0000-7000-8000-000000000002',
     'English only greeting', NULL, NULL,
     'REGISTERED')
