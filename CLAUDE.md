# CLAUDE.md — Cooperative Retail and Distribution System (Knoweb / COOPFED)

Standing instructions for working in this repository. Read fully before any task. `docs/HANDOVER.md` is the one-time briefing; `docs/DECISIONS_PENDING.md` lists the assumptions you build to.
...
Requirements baseline (docs 00–13, 15, 16): Google Drive folder `1DKsOlf4k8vlOJCjp2oVaEQlg-XCs1fgh`.
...
- **Document sources live here.** Any document you re-issue or create is written as Markdown (or the generator script) under `docs/sources/` and rendered to PDF into `docs/design/`; upload the PDF to the Drive folder and bump the register. Never edit a PDF's content without a source.
