...
| S0-07 | Web shell: PKCE auth, scope context and banner, module registration, i18n loader, design tokens, component seeds | in progress: steps 1 to 4 of 5 (login; API client; scope banner, module definitions and navigation; design tokens, bundled fonts and the first three components) done 20 Sep; `docs/PROGRESS.md` | Verify each item against 17A §9 and doc 30; fix gaps | 3 | Login → banner → hello page in three languages |
